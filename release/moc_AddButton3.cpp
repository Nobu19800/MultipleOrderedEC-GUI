...
struct qt_meta_stringdata_AddButton3_t {
    QByteArrayData data[8];
    char stringdata[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AddButton3_t, stringdata) + ofs \
...
void AddButton3::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddButton3 *_t = static_cast<AddButton3 *>(_o);
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< QWidget*(*)>(_a[1])),(*reinterpret_cast< CompLayout*(*)>(_a[2]))); break;
        ...
        {
            typedef void (AddButton3::*_t)(QWidget * , CompLayout * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddButton3::clicked)) {
                *result = 0;
            }
        }
    }
